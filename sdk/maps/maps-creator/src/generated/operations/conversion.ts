...
export class ConversionImpl implements Conversion {
  ...
  private _list(
    ...
    return this.client.sendOperationRequest(
      operationArguments,
      listOperationSpec
    ) as Promise<ConversionListOperationResponse>;
  }
  ...
  get(
    ...
    return this.client.sendOperationRequest(
      operationArguments,
      getOperationSpec
    ) as Promise<ConversionGetResponse>;
  }
  ...
  getOperation(
    ...
    ) as Promise<ConversionGetOperationResponse>;
  }
  ...
  private _listNext(
    ...
    ) as Promise<ConversionListNextResponse>;
  }
...
const convertOperationSpec: coreHttp.OperationSpec = {
  path: "/conversions",
  httpMethod: "POST",
  responses: {
    200: {
