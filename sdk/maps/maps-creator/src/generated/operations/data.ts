...
export class DataImpl implements Data {
  ...
  beginUploadPreview(
    ...
    uploadContent: coreHttp.HttpRequestBody,
  ...
  listPreview(
    ...
    ) as Promise<DataListPreviewResponse>;
  }
  ...
  downloadPreview(
    ...
    ) as Promise<DataDownloadPreviewResponse>;
  }
  ...
  getOperationPreview(
    ...
    ) as Promise<DataGetOperationPreviewResponse>;
  }
...
const uploadPreview$binaryOperationSpec: coreHttp.OperationSpec = {
  path: "/mapData",
  httpMethod: "POST",
  responses: {
    200: {
...
const uploadPreview$jsonOperationSpec: coreHttp.OperationSpec = {
  path: "/mapData",
  httpMethod: "POST",
  responses: {
    200: {
...
const listPreviewOperationSpec: coreHttp.OperationSpec = {
  path: "/mapData",
  httpMethod: "GET",
  responses: {
    200: {
...
const updatePreviewOperationSpec: coreHttp.OperationSpec = {
  path: "/mapData/{udid}",
  httpMethod: "PUT",
  responses: {
    200: {
...
const downloadPreviewOperationSpec: coreHttp.OperationSpec = {
  path: "/mapData/{udid}",
  httpMethod: "GET",
  responses: {
    200: {
...
const deletePreviewOperationSpec: coreHttp.OperationSpec = {
  path: "/mapData/{udid}",
  httpMethod: "DELETE",
  responses: {
    204: {},
...
const getOperationPreviewOperationSpec: coreHttp.OperationSpec = {
