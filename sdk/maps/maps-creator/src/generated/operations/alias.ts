...
export class AliasImpl implements Alias {
  ...
  create(options?: AliasCreateOptionalParams): Promise<AliasCreateResponse> {
    ...
    return this.client.sendOperationRequest(
      operationArguments,
      createOperationSpec
    ) as Promise<AliasCreateResponse>;
  }
  ...
  private _list(
    ...
    return this.client.sendOperationRequest(
      operationArguments,
      listOperationSpec
    ) as Promise<AliasListOperationResponse>;
  }
  ...
  assign(
    ...
    return this.client.sendOperationRequest(
      operationArguments,
      assignOperationSpec
    ) as Promise<AliasAssignResponse>;
  }
  ...
  getDetails(
    ...
    ) as Promise<AliasGetDetailsResponse>;
  }
  ...
  private _listNext(
    ...
    ) as Promise<AliasListNextResponse>;
  }
}
...
const assignOperationSpec: coreHttp.OperationSpec = {
