...
export class RouteClient extends RouteClientContext {
    constructor(credentials: coreHttp.TokenCredential | coreHttp.ServiceClientCredentials, options?: RouteClientOptionalParams);
    // (undocumented)
    route: Route;
}

// @public (undocumented)
export class RouteClientContext extends coreHttp.ServiceClient {
    constructor(credentials: coreHttp.TokenCredential | coreHttp.ServiceClientCredentials, options?: RouteClientOptionalParams);
    // (undocumented)
    apiVersion: string;
    // (undocumented)
...
// @public
export interface RouteClientOptionalParams extends coreHttp.ServiceClientOptions {
    apiVersion?: string;
    endpoint?: string;
    geography?: Geography;
    xMsClientId?: string;
...
// @public
export interface RouteGetRouteDirectionsOptionalParams extends coreHttp.OperationOptions {
...
// @public
export interface RouteGetRouteRangeOptionalParams extends coreHttp.OperationOptions {
    accelerationEfficiency?: number;
    auxiliaryPowerInkW?: string;
    auxiliaryPowerInLitersPerHour?: number;
    avoid?: RouteAvoidType[];
...
export type RouteGetRouteRangeResponse = GetRouteRangeResponse & {
    _response: coreHttp.HttpResponse & {
        bodyAsText: string;
        parsedBody: GetRouteRangeResponse;
    };
};
...
// @public
export interface RoutePostRouteDirectionsBatchOptionalParams extends coreHttp.OperationOptions {
    resumeFrom?: string;
...
export type RoutePostRouteDirectionsBatchResponse = RouteDirectionsBatchResponse & {
    _response: coreHttp.HttpResponse & {
        bodyAsText: string;
        parsedBody: RouteDirectionsBatchResponse;
    };
};

// @public
export interface RoutePostRouteDirectionsBatchSyncOptionalParams extends coreHttp.OperationOptions {
}
...
// @public
export interface RoutePostRouteDirectionsOptionalParams extends coreHttp.OperationOptions {
    accelerationEfficiency?: number;
    alternativeType?: AlternativeRouteType;
    arriveAt?: Date;
    auxiliaryPowerInkW?: string;
...
// @public
export interface RoutePostRouteMatrixOptionalParams extends coreHttp.OperationOptions {
    arriveAt?: Date;
    avoid?: RouteAvoidType[];
    computeTravelTimeFor?: ComputeTravelTimeFor;
    departAt?: Date;
...
// @public
export interface RoutePostRouteMatrixSyncOptionalParams extends coreHttp.OperationOptions {
    arriveAt?: Date;
    avoid?: RouteAvoidType[];
    computeTravelTimeFor?: ComputeTravelTimeFor;
    departAt?: Date;
