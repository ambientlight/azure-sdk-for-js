...
export class RouteImpl implements Route {
  ...
  postRouteMatrixSync(
    ...
    ) as Promise<RoutePostRouteMatrixSyncResponse>;
  }
  ...
  getRouteDirections(
    ...
    ) as Promise<RouteGetRouteDirectionsResponse>;
  }
  ...
  postRouteDirections(
    ...
    ) as Promise<RoutePostRouteDirectionsResponse>;
  }
  ...
  getRouteRange(
    ...
    ) as Promise<RouteGetRouteRangeResponse>;
  }
  ...
  postRouteDirectionsBatchSync(
    ...
    ) as Promise<RoutePostRouteDirectionsBatchSyncResponse>;
  }
...
const postRouteMatrixOperationSpec: coreHttp.OperationSpec = {
...
const postRouteMatrixSyncOperationSpec: coreHttp.OperationSpec = {
...
const getRouteDirectionsOperationSpec: coreHttp.OperationSpec = {
...
const postRouteDirectionsOperationSpec: coreHttp.OperationSpec = {
  path: "/route/directions/{format}",
  httpMethod: "POST",
  responses: {
    200: {
...
const getRouteRangeOperationSpec: coreHttp.OperationSpec = {
...
const postRouteDirectionsBatchOperationSpec: coreHttp.OperationSpec = {
...
const postRouteDirectionsBatchSyncOperationSpec: coreHttp.OperationSpec = {
