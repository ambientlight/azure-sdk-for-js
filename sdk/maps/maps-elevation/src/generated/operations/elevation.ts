...
export class ElevationImpl implements Elevation {
  ...
  getDataForPoints(
    ...
    ) as Promise<ElevationGetDataForPointsResponse>;
  }
  ...
  postDataForPoints(
    ...
    ) as Promise<ElevationPostDataForPointsResponse>;
  }
  ...
  getDataForPolyline(
    ...
    ) as Promise<ElevationGetDataForPolylineResponse>;
  }
  ...
  postDataForPolyline(
    ...
    ) as Promise<ElevationPostDataForPolylineResponse>;
  }
  ...
  getDataForBoundingBox(
    ...
    ) as Promise<ElevationGetDataForBoundingBoxResponse>;
  }
}
// Operation Specifications
const serializer = new coreHttp.Serializer(Mappers, /* isXml */ false);

const getDataForPointsOperationSpec: coreHttp.OperationSpec = {
...
const postDataForPointsOperationSpec: coreHttp.OperationSpec = {
  path: "/elevation/point/{format}",
  httpMethod: "POST",
  responses: {
    200: {
...
const getDataForPolylineOperationSpec: coreHttp.OperationSpec = {
...
const postDataForPolylineOperationSpec: coreHttp.OperationSpec = {
  path: "/elevation/line/{format}",
  httpMethod: "POST",
  responses: {
    200: {
...
const getDataForBoundingBoxOperationSpec: coreHttp.OperationSpec = {
